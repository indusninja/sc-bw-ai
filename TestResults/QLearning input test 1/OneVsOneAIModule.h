...
class OneVsOneAIModule : public BWAPI::AIModule, public QLearning::DataProvider
{
private:
	bool        m_bGameOver;
    float       m_prevReward;
    ...
    //saved State
	static const int STATE_DATA_PER_UNIT_SIZE = 6;
    static const int STATE_DATA_SIZE = STATE_DATA_PER_UNIT_SIZE * 2 + 2;
